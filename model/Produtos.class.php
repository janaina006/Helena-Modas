...
Class Produtos extends Conexao{
	...
	function GetProdutos(){
		...
		$query = "SELECT * FROM {$this->prefix}produtos p INNER JOIN {$this->prefix}categoria c ON p.pro_categoria = c.cate_id";
	...
	function Preparar($pro_nome, $pro_categoria, $pro_ativo, $pro_modelo, $pro_ref, $pro_fabricante,
            $pro_valor, $pro_estoque, $pro_peso , $pro_altura, $pro_largura, $pro_comprimento ,
            $pro_img, $pro_desc, $pro_slug=null){
                ...
                $this->setPro_ref($pro_fabricante);
